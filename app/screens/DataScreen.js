        ...
        <ScrollView style={[style.wrapper, style.paddingTop]}>
            <VStack style={style.marginBottom}>
                ...
                <View style={[style.flexBetween, style.flexHorizontal, style.marginForm]}>
                    ...
                    <Select w='150' selectedValue={bloodGroup} placeholder=''
                ...
                <View style={[style.flexBetween, style.flexHorizontal, style.marginForm]}>
                    ...
                    <Checkbox isChecked={organDonorState} onChange={(value) => setOrganDonorState(value)}
                              value={organDonorState}/>
                </View>
                <Collapse isExpanded={isDiseasesExpanded} onToggle={(expanded) => {
                    setDiseasesExpanded(expanded)
                }}>
                    <CollapseHeader>
                ...
                <Collapse isExpanded={isAllergiesExpanded} onToggle={(expanded) => {
                ...
                <Collapse isExpanded={isVaccinesExpanded} onToggle={(expanded) => {
                    setVaccinesExpanded(expanded)
                }}>
                    <CollapseHeader>
                        <View style={[style.paddingForm, style.dividerTop, style.flexBetween]}>
                            <Text>Impfungen</Text>
